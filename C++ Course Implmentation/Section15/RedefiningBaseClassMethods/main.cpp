...
int main() 
{
    ...
    a1.withdraw(5000.0);
    cout << a1 << endl;   // Insufficient funds
    
    
    cout << "\n===== Savings Account class ================" << endl;
    Savings_Account s1 {1000, 5.0};
    cout << s1 << endl;       // Saving Account balance: 1000, Interest rate: 5
    
    s1.deposit(1000);
    cout << s1 << endl;        // Savings Account balance 2050, Interest rate: 5
    
    s1.withdraw(2000);
    cout << s1 << endl;        // Savings Account balnce 50, Interest rate: 5
    
    s1.withdraw(1000);
    cout << s1 << endl;         // Saving Account balance 50, Interest rate: 5
