...
int main() 
{
    ...
    // Note precision 3 is after the decimal
    std::cout << "-- Percision 3 scientific -----------" << std::endl;
    ...
    std::cout << "-- Percision 3 - scientific - uppercase ------" << std::endl;
    std::cout << std::setprecision(3) << std::scientific << std::uppercase;
    std::cout << num1 << std::endl;
    std::cout << num2 << std::endl;
    std::cout << num3 << std::endl;
    
    std::cout << "-- Percision 3 - fixed - uppercase showpos------------" << std::endl;
    ...
    // show trailing zeros up to 10 precision
