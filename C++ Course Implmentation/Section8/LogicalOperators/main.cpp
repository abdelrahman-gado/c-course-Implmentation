...
//    cout << num << " is on one of the bounds which are " << lower << " and " << upper << " : " << on_bounds << endl;
    ...
    // Determine is you need to wear a coat based on the temp and wind speed.
    ...
    // requires a coat either wind is too high OR temperature is too low
